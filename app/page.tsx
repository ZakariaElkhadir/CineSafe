...
import { Bell, ArrowDown,  Home, Compass, Film, Heart, Settings } from "lucide-react";
function page() {
  return (
    <>
      <header>
  ...
  <nav className="w-64 min-h-screen bg-gray-800 text-white ml-20 -mt-12 rounded-2xl p-6 fixed">
    ...
    <ul className="space-y-6">
      <li>
        <a href="#" className="flex items-center gap-3 px-4 py-2 hover:bg-gray-700 rounded-lg transition-all">
          <Home size={20} />
          <span>Home</span>
        </a>
      </li>
  ...
  <main className="flex-1 p-4 ml-84">
    {/* Main content */}
  </main>
</div>
    </>
